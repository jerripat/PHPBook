...
<form name="product" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	...
	<p>Product item name <input type="text" name="item" size="20" value="<?php if (isset($_POST["item"])) { echo( $_POST["item"]) ;} ?>" /></p>

	<p>Product cost <input type="text" name="cost" size="10" value="<?php if (isset($_POST["cost"])) { echo( $_POST["cost"]) ;} ?>" /></p>
    
    <p>Tax value <input type="text" name="tax" size="10" value="20" /> %</p>
